...
- (void)configureView
{
    ...
    if (self.agent)
    {
        ...
        //     the last name?
        NSString *coverName = self.agent.coverName;
        NSArray *agentCoverNameArray = [coverName componentsSeparatedByString:@" " ];
        //
        ...
        //     string?
        self.title = [NSString stringWithFormat:@"Agent %@",[agentCoverNameArray lastObject]];
